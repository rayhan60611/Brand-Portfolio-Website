...
$result = $conn->query("SELECT * FROM `brandportfolio` WHERE gpmid='Vacant' and status=1 group by brand order by brand ASC");
...
<head>
    ...
    <title>Vacant Brand Wise GPM List</title>
...
<h1 class="text-center" style="color: #0072bb">Vacant Brand Wise GPM List</h1>
    ...
    <div class="row shadow-lg bg-white rounded p-2 m-4">
        ...
        <div class="col-md-12">
            <div class="btn-group d-flex justify-content-center" role="group" aria-label="Basic example">
                ...
                <a type="button" href="userlist2gpm.php" class="btn btn-outline-success">Brand Portfoilo List</a></h4>
                ...
                <?php foreach ($user as $row) : ?>
                    ...
                    <tr class="small">
                        ...
                        <td>
                            ...
                            <a href="VacantGpmUpdate.php?brand=<?php echo $row['brand']; ?>"> <i class="fas fa-user-tie fa-2x" style="color: #ff2d49" aria-hidden="true"></i></a>
                        </td>
                    </tr>
